      ...
      size: {
        ...
        w:
          type === "rect"
            ...
            : Math.abs(coords.final.x - coords.initial.x),
      },
      ...(type === "pencil" && { pixels }),
    });
...
export function addExistingShapes(
  ...
  shapes.forEach((shape) => {
    if (shape.type == "rect") {
      drawRectangle(
        ctx,
        shape.cords.initial.x,
        shape.cords.initial.y,
        shape.size.w,
        shape.size.h,
      );
    }
